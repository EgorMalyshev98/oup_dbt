        ...
        from
            (
                select
                    ...
                    --СТОИМОСТЬ проекта [Факт]
                    sum(coalesce("s_act_CC_SMRSsI", 0))
                    + sum(coalesce("s_act_CC_SMRSpI", 0)) as "СТОИМОСТЬ проекта [Факт]",
                    --СТОИМОСТЬ проекта [План]
                    sum(coalesce("s_pln_CC_SMRSsI", 0))
                    + sum(coalesce("s_pln_CC_SMRSpI", 0)) as "СТОИМОСТЬ проекта [План]"
