...
-- Исключение: в НЗ на март 2024 на объекте АД108_Дюртюли-Ачит присутствует факт. в фильтре перечислены все столбцы, чтобы исключить уникальную строку.
and ("object" != 'АД108_Дюртюли-Ачит' and nz_year != '2024' and nz_month != 'Март' and project_type != 'НЗ')