...
select  -- noqa: ST06
    ...
    round(
        sum(
            case when t1."Ресурс" = 'Собственная' then t1."Фактическая трудоемкость" end
        )::numeric,
        2
    ) as ownworkload_1c,
    ...
    round(
        sum(
            case
                when t1."Ресурс" = 'Собственная'
                then t1."Фактическая трудоемкость" * mim."leasing"
            end
        )::numeric,
        2
    ) as leasing_1c,
    ...
    round(
        sum(
            case
                when t1."Ресурс" = 'Собственная'
                then t1."Фактическая трудоемкость" * mim."repair"
            end
        )::numeric,
        2
    ) as repair_1c,
    ...
    round(
        sum(
            case
                when t1."Ресурс" = 'Собственная'
                then t1."Фактическая трудоемкость" * mim."fuel"
            end
        )::numeric,
        2
    ) as fuel_1c,
